...
export default function AdminPage() {
    ...
    const handleBulkDuplicate = async () => {
        ...
        for (const bairroNome of dupBairros) {
            ...
            if (pages.find(p => p.slug === slug)) continue;

            await duplicatePage(duplicateSourceId, bairroNome, slug, {
                lat: bairro.geo.lat,
                lng: bairro.geo.lng,
                cep: bairro.cep,
                zona: bairro.zona,
    ...
    const handleSaveSettings = async () => {
        if (settingsUser && settingsPass) {
            await changePassword(settingsUser, settingsPass);
